...
// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
var LFT = '<span class="IOUtils" style="white-space: pre; font-family: monospace">';
var RGT = '</span>';
...
{ _outputBuffer += '<table class="IOUtils-startTable"><tr>';
  _rowStarted = true;
}
...
//  _outputBuffer += ('<td style="text-align: right;">'+LFT+msg+RGT+'</td>');
  _outputBuffer += ('<td class="IOUtils-writeCell">'+LFT+msg+RGT+'</td>');
}
